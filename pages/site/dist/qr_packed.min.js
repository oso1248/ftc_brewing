...
var qrcode = (function () {
  ...
  function k(h, b, e, d, c, a) {
    ...
    this.buildFunctionPattern = function () {
      ...
      for (var e = this.alignmentPatternCenters.length, b = 0; b < e; b++)
        for (var a = this.alignmentPatternCenters[b] - 2, h = 0; h < e; h++) (0 == b && (0 == h || h == e - 1)) || (b == e - 1 && 0 == h) || c.setRegion(this.alignmentPatternCenters[h] - 2, a, 5, 5);
  ...
  function I(h, b) {
    ...
    this.setRegion = function (d, c, e, b) {
      ...
      for (; c < b; c++) for (var h = c * this.rowSize, a = d; a < e; a++) this.bits[h + (a >> 5)] |= 1 << (a & 31);
    };
  }
  function G(a, b) {
  ...
  function T(a) {
    ...
    this.readVersion = function () {
      ...
      for (var d = 0, c = e - 11, b = 5; 0 <= b; b--) for (var a = e - 9; a >= c; a--) d = this.copyBit(a, b, d);
      ...
      d = 0;
      for (a = 5; 0 <= a; a--) for (b = e - 9; b >= c; b--) d = this.copyBit(a, b, d);
      this.parsedVersion = k.decodeVersionInformation(d);
      if (null != this.parsedVersion && this.parsedVersion.DimensionForVersion == e) return this.parsedVersion;
    ...
    this.readCodewords = function () {
      ...
      for (var c = d.buildFunctionPattern(), a = !0, h = Array(d.TotalCodewords), m = 0, f = 0, g = 0, k = b - 1; 0 < k; k -= 2) {
        6 == k && k--;
        for (var x = 0; x < b; x++)
          for (var v = a ? b - 1 - x : x, t = 0; 2 > t; t++) c.get_Renamed(k - t, v) || (g++, (f <<= 1), this.bitMatrix.get_Renamed(k - t, v) && (f |= 1), 8 == g && ((h[m++] = f), (f = g = 0)));
        a ^= 1;
      }
  ...
  function w(a, b) {
    ...
    this.evaluateAt = function (c) {
      ...
      for (var e = this.coefficients[0], b = 1; b < d; b++) e = n.addOrSubtract(this.field.multiply(c, e), this.coefficients[b]);
      return e;
    };
    ...
    this.multiply1 = function (c) {
      ...
      var d = this.coefficients,
        b = d.length;
      c = c.coefficients;
      for (var e = c.length, a = Array(b + e - 1), h = 0; h < b; h++) for (var f = d[h], g = 0; g < e; g++) a[h + g] = n.addOrSubtract(a[h + g], this.field.multiply(f, c[g]));
  ...
  function S() {
    ...
    this.selectBestPatterns = function () {
      ...
      if (3 < a) {
        for (var b = 0, e = 0, d = 0; d < a; d++) var c = this.possibleCenters[d].EstimatedModuleSize, b = b + c, e = e + c * c;
        var p = b / a;
            ...
            if (4 == b)
              if (this.foundPatternCross(l)) {
                if ((b = this.handlePossibleCenter(l, m, f)))
                  (c = 2), this.hasSkipped ? (h = this.haveMultiplyConfirmedCenters()) : ((b = this.findRowSkip()), b > l[2] && ((m += b - l[2] - c), (f = d - 1)));
                else {
                  do f++;
  ...
  function R(a, b, e, d, c, f, l) {
    ...
    this.foundPatternCross = function (c) {
      for (var d = this.moduleSize, b = d / 2, a = 0; 3 > a; a++) if (Math.abs(d - c[a]) >= b) return !1;
      return !0;
    };
    ...
    this.handlePossibleCenter = function (c, d, b) {
      ...
      if (!isNaN(d)) {
        c = (c[0] + c[1] + c[2]) / 3;
        for (var a = this.possibleCenters.length, e = 0; e < a; e++) if (this.possibleCenters[e].aboutEquals(c, d, b)) return new M(b, d, c);
        b = new M(b, d, c);
  ...
  function X(a, b, e) {
    ...
    this.getFigureString = function (b) {
      ...
      do
        3 <= b
          ? ((c = this.getNextBits(10)), 100 > c && (d += '0'), 10 > c && (d += '0'), (b -= 3))
          : 2 == b
  ...
  var F = {
    ...
    sampleGrid3: function (a, b, e) {
      for (var d = new I(b), c = Array(b << 1), h = 0; h < b; h++) {
        for (var f = c.length, m = h + 0.5, k = 0; k < f; k += 2) (c[k] = (k >> 1) + 0.5), (c[k + 1] = m);
  ...
  k.VERSIONS = [
    new k(1, [], new f(7, new a(1, 19)), new f(10, new a(1, 16)), new f(13, new a(1, 13)), new f(17, new a(1, 9))),
    new k(2, [6, 18], new f(10, new a(1, 34)), new f(16, new a(1, 28)), new f(22, new a(1, 22)), new f(28, new a(1, 16))),
    new k(3, [6, 22], new f(15, new a(1, 55)), new f(26, new a(1, 44)), new f(18, new a(2, 17)), new f(22, new a(2, 13))),
    new k(4, [6, 26], new f(20, new a(1, 80)), new f(18, new a(2, 32)), new f(26, new a(2, 24)), new f(16, new a(4, 9))),
    new k(5, [6, 30], new f(26, new a(1, 108)), new f(24, new a(2, 43)), new f(18, new a(2, 15), new a(2, 16)), new f(22, new a(2, 11), new a(2, 12))),
    new k(6, [6, 34], new f(18, new a(2, 68)), new f(16, new a(4, 27)), new f(24, new a(4, 19)), new f(28, new a(4, 15))),
    new k(7, [6, 22, 38], new f(20, new a(2, 78)), new f(18, new a(4, 31)), new f(18, new a(2, 14), new a(4, 15)), new f(26, new a(4, 13), new a(1, 14))),
    new k(8, [6, 24, 42], new f(24, new a(2, 97)), new f(22, new a(2, 38), new a(2, 39)), new f(22, new a(4, 18), new a(2, 19)), new f(26, new a(4, 14), new a(2, 15))),
    new k(9, [6, 26, 46], new f(30, new a(2, 116)), new f(22, new a(3, 36), new a(2, 37)), new f(20, new a(4, 16), new a(4, 17)), new f(24, new a(4, 12), new a(4, 13))),
    new k(10, [6, 28, 50], new f(18, new a(2, 68), new a(2, 69)), new f(26, new a(4, 43), new a(1, 44)), new f(24, new a(6, 19), new a(2, 20)), new f(28, new a(6, 15), new a(2, 16))),
    new k(11, [6, 30, 54], new f(20, new a(4, 81)), new f(30, new a(1, 50), new a(4, 51)), new f(28, new a(4, 22), new a(4, 23)), new f(24, new a(3, 12), new a(8, 13))),
    new k(12, [6, 32, 58], new f(24, new a(2, 92), new a(2, 93)), new f(22, new a(6, 36), new a(2, 37)), new f(26, new a(4, 20), new a(6, 21)), new f(28, new a(7, 14), new a(4, 15))),
    new k(13, [6, 34, 62], new f(26, new a(4, 107)), new f(22, new a(8, 37), new a(1, 38)), new f(24, new a(8, 20), new a(4, 21)), new f(22, new a(12, 11), new a(4, 12))),
    new k(14, [6, 26, 46, 66], new f(30, new a(3, 115), new a(1, 116)), new f(24, new a(4, 40), new a(5, 41)), new f(20, new a(11, 16), new a(5, 17)), new f(24, new a(11, 12), new a(5, 13))),
    new k(15, [6, 26, 48, 70], new f(22, new a(5, 87), new a(1, 88)), new f(24, new a(5, 41), new a(5, 42)), new f(30, new a(5, 24), new a(7, 25)), new f(24, new a(11, 12), new a(7, 13))),
    new k(16, [6, 26, 50, 74], new f(24, new a(5, 98), new a(1, 99)), new f(28, new a(7, 45), new a(3, 46)), new f(24, new a(15, 19), new a(2, 20)), new f(30, new a(3, 15), new a(13, 16))),
    new k(17, [6, 30, 54, 78], new f(28, new a(1, 107), new a(5, 108)), new f(28, new a(10, 46), new a(1, 47)), new f(28, new a(1, 22), new a(15, 23)), new f(28, new a(2, 14), new a(17, 15))),
    new k(18, [6, 30, 56, 82], new f(30, new a(5, 120), new a(1, 121)), new f(26, new a(9, 43), new a(4, 44)), new f(28, new a(17, 22), new a(1, 23)), new f(28, new a(2, 14), new a(19, 15))),
    new k(19, [6, 30, 58, 86], new f(28, new a(3, 113), new a(4, 114)), new f(26, new a(3, 44), new a(11, 45)), new f(26, new a(17, 21), new a(4, 22)), new f(26, new a(9, 13), new a(16, 14))),
    new k(20, [6, 34, 62, 90], new f(28, new a(3, 107), new a(5, 108)), new f(26, new a(3, 41), new a(13, 42)), new f(30, new a(15, 24), new a(5, 25)), new f(28, new a(15, 15), new a(10, 16))),
    new k(21, [6, 28, 50, 72, 94], new f(28, new a(4, 116), new a(4, 117)), new f(26, new a(17, 42)), new f(28, new a(17, 22), new a(6, 23)), new f(30, new a(19, 16), new a(6, 17))),
    new k(22, [6, 26, 50, 74, 98], new f(28, new a(2, 111), new a(7, 112)), new f(28, new a(17, 46)), new f(30, new a(7, 24), new a(16, 25)), new f(24, new a(34, 13))),
    new k(23, [6, 30, 54, 74, 102], new f(30, new a(4, 121), new a(5, 122)), new f(28, new a(4, 47), new a(14, 48)), new f(30, new a(11, 24), new a(14, 25)), new f(30, new a(16, 15), new a(14, 16))),
    new k(24, [6, 28, 54, 80, 106], new f(30, new a(6, 117), new a(4, 118)), new f(28, new a(6, 45), new a(14, 46)), new f(30, new a(11, 24), new a(16, 25)), new f(30, new a(30, 16), new a(2, 17))),
    new k(25, [6, 32, 58, 84, 110], new f(26, new a(8, 106), new a(4, 107)), new f(28, new a(8, 47), new a(13, 48)), new f(30, new a(7, 24), new a(22, 25)), new f(30, new a(22, 15), new a(13, 16))),
    new k(26, [6, 30, 58, 86, 114], new f(28, new a(10, 114), new a(2, 115)), new f(28, new a(19, 46), new a(4, 47)), new f(28, new a(28, 22), new a(6, 23)), new f(30, new a(33, 16), new a(4, 17))),
    new k(27, [6, 34, 62, 90, 118], new f(30, new a(8, 122), new a(4, 123)), new f(28, new a(22, 45), new a(3, 46)), new f(30, new a(8, 23), new a(26, 24)), new f(30, new a(12, 15), new a(28, 16))),
    new k(
      28,
      [6, 26, 50, 74, 98, 122],
    ...
    new k(32, [6, 34, 60, 86, 112, 138], new f(30, new a(17, 115)), new f(28, new a(10, 46), new a(23, 47)), new f(30, new a(10, 24), new a(35, 25)), new f(30, new a(19, 15), new a(35, 16))),
    new k(
      33,
      [6, 30, 58, 86, 114, 142],
  ...
  G.getDataBlocks = function (a, b, e) {
    ...
    for (b = g = 0; b < d; b++) for (f = 0; f < h; f++) e[f].codewords[b] = a[g++];
    for (f = c; f < h; f++) e[f].codewords[d] = a[g++];
    k = e[0].codewords.length;
    for (b = d; b < k; b++) for (f = 0; f < h; f++) e[f].codewords[f < c ? b : b + 1] = a[g++];
    return e;
  };
  var H = {
  ...
  H.DATA_MASKS = [
    new (function () {
      this.unmaskBitMatrix = function (a, b) {
        for (var e = 0; e < b; e++) for (var d = 0; d < b; d++) this.isMasked(e, d) && a.flip(d, e);
      };
  ...
  E.rsDecoder = new (function (a) {
    ...
    this.decode = function (a, e) {
      ...
      if (!h)
        for (
          f = new w(this.field, c), b = this.runEuclideanAlgorithm(this.field.buildMonomial(e, 1), f, e), f = b[1], b = this.findErrorLocations(b[0]), c = this.findErrorMagnitudes(f, b, !1), f = 0;
          f < b.length;
          f++
        ) {
  ...
  var g = {
      ...
      setWebcam: function (a) {
          ...
          try {
            navigator.mediaDevices.enumerateDevices().then(function (a) {
              a.forEach(function (a) {
                console.log('deb1');
                'videoinput' === a.kind && -1 < a.label.toLowerCase().search('back') && (e = [{ sourceId: a.deviceId }]);
        ...
        b.getUserMedia
          ...
          ? ((g.webkit = !0), b.webkitGetUserMedia({ video: e, audio: !1 }, g.vidSuccess, g.vidError))
          : b.mozGetUserMedia && ((g.moz = !0), b.mozGetUserMedia({ video: e, audio: !1 }, g.vidSuccess, g.vidError));
      },
      decode: function (a) {
      ...
      process: function (a) {
        ...
        a = '';
        for (d = 0; d < f.length; d++) for (c = 0; c < f[d].length; c++) a += String.fromCharCode(f[d][c]);
        f = new Date().getTime();
        console.log(f - b);
      ...
      getMiddleBrightnessPerArea: function (a) {
        ...
        for (c = 0; 4 > c; c++) for (f = 0; 4 > f; f++) a[f][c] = Math.floor((d[f][c][0] + d[f][c][1]) / 2);
        return a;
      },
      grayScaleToBitmap: function (a) {
        for (
          var b = g.getMiddleBrightnessPerArea(a), e = b.length, d = Math.floor(g.width / e), c = Math.floor(g.height / e), f = new ArrayBuffer(g.width * g.height), f = new Uint8Array(f), h = 0;
          h < e;
          h++
        )
          for (var m = 0; m < e; m++) for (var k = 0; k < c; k++) for (var n = 0; n < d; n++) f[d * m + n + (c * h + k) * g.width] = a[d * m + n + (c * h + k) * g.width] < b[m][h] ? !0 : !1;
        return f;
      },
      grayscale: function () {
