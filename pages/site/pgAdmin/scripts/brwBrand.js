  ...
  axios.get('/api/brand/brw')
    .then(res => {
      ...
      var table = new Tabulator("#list", {
        ...
        {title:"Brand", field:"brand", width:100,hozAlign:"center", responsive:0},
        {title:"Standard Hops", field:"hop_std", width:140,hozAlign:"center", responsive:0},
        {title:"Craft Hops", field:"hop_crft", width:140,hozAlign:"center", responsive:0},
        {title:"Dry Hops", field:"hop_dry", width:140,hozAlign:"center", responsive:0},
        {title:"Super Sacks", field:"supr_sac", width:140,hozAlign:"center", responsive:0},
