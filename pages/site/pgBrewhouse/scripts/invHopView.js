...
function invDatesDay() {
  ...
  axios
    .post('/api/inventory/hop/daily/dates')
    .then((data) => {
...
function loadTableDailyMid(date) {
  ...
  axios
    .post('/api/inventory/hop/daily/view', timeSpan)
    .then((res) => {
...
function invDatesWeek() {
  ...
  invDates.innerHTML = `<option value="" disabled selected hidden>Select Date</option>`;
  axios
    .post('/api/inventory/hop/weekly/dates')
    .then((data) => {
      let invDate = data.data;
      return invDate.map((listItem) => {
        let invDate = createNode('option');
...
function loadTableWeeklyHard(date) {
  ...
  axios
    .post('/api/inventory/hop/weekly/view', timeSpan)
    .then((res) => {
      let tableData = res.data;
...
function loadTableWeeklyLastBrewsHard(date) {
  ...
  timeSpan.end = end;
  axios
    .post('/api/inventory/hop/daily/lastbrews', timeSpan)
    .then((res) => {
...
function loadTableWeeklySets(date) {
  ...
  timeSpan.end = end;
  axios
    .post('/api/inventory/hop/sets/view', timeSpan)
    .then((res) => {
      let tableData = res.data;
...
function loadTableWeeklyRolling(date) {
  ...
  timeSpan.end = end;
  axios
    .post('/api/inventory/hop/weekly/view/rolling', timeSpan)
    .then((res) => {
      let tableData = res.data;
