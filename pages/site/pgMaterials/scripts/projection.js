    ...
    .then((res) => {
      ...
      projectionTable = new Tabulator('#projectionTbl', {
        ...
        columns: [
          ...
          { title: weeks[0], field: 'week0', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[1], field: 'week1', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[2], field: 'week2', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[3], field: 'week3', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[4], field: 'week4', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[5], field: 'week5', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[6], field: 'week6', hozAlign: 'center', formatter: negativeCell },
          { title: weeks[7], field: 'week7', hozAlign: 'center', formatter: negativeCell },
        ],
      });
    })
